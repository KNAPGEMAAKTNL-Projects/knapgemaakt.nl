      ...
      >
        ...
        <div className="flex items-center gap-4 p-5 pb-4">
          <img
            ...
            className="w-12 h-12 rounded-full object-cover object-top shrink-0 ring-2 ring-accent/30"
          />
          <div>
          ...
          <button
            ...
            className="ml-auto p-1.5 text-canvas/40 hover:text-accent transition-colors shrink-0 self-start cursor-pointer"
            aria-label="Sluiten"
          >
        ...
        <div className="px-4 pb-3 space-y-2">
          ...
          <a
            href="/contact/"
            className="group flex items-center gap-3 p-3 border border-canvas/10 hover:border-accent hover:bg-accent/5 transition-all duration-200"
          >
            <span className="w-9 h-9 bg-accent flex items-center justify-center shrink-0">
          ...
          >
            ...
            <span className="text-sm text-canvas/80 group-hover:text-accent transition-colors">
        ...
        <div className="border-t border-canvas/10 mx-4">
          <a
            href="/contact/"
            className="group flex items-center gap-2 py-3 text-sm font-bold uppercase tracking-tight text-canvas/50 hover:text-accent transition-colors"
          >
            Contactgegevens
      ...
      <button
        ...
        className={`
          ...
          ${open
            ...
            : 'bg-ink text-accent border border-canvas/20 hover:bg-ink/90 hover:shadow-xl hover:scale-105'
          }
